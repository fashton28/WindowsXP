  ...
  return (
    <div>
      <div className='w-full h-8 bg-gradient-to-t from-blue-800 to-blue-500 rounded flex items-center justify-between'>
        <button id='start' className='cursor-pointer hover:brightness-110 transition-all duration-100 h-8' onClick={() => setSideBar(!sideBar)}><img src="/src/assets/startButton.png" alt="startButton" className='w-25'/></button>
